...
use App\GeometryLibrary\MathUtil;
...
/**
  ...
  /**
    ...
    public static function isLocationOnEdge_custom($point, $polygon, $tolerance = self::DEFAULT_TOLERANCE, $geodesic = true) {
        return self::isLocationOnEdgeOrPath_custom($point, $polygon, true, $geodesic, $tolerance);
    }   
 ...
 /**
    ...
    private static function isLocationOnEdgeOrPath_custom($point, $poly, $closed, $geodesic, $toleranceEarth) {
